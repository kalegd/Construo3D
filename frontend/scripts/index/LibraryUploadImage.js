...
export default class LibraryUploadImage {
    constructor() {
        this._setupEventListeners();
    }

    _setupEventListeners() {
        document.getElementById("library-upload-image-submit")
    ...
    _uploadFile() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                global.dataStore.addImage(response.data.image);
...
global.libraryUploadImage = new LibraryUploadImage();
