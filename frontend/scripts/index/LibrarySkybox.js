...
export default class LibrarySkybox {
    constructor() {
    ...
    _setupEventListeners() {
        document.getElementById("library-edit-skybox-submit")
            .addEventListener("click", () => { this._editSkybox(); });
        document.getElementById("library-delete-skybox-submit")
            .addEventListener("click", () => { this._deleteSkybox(); });
    }
    ...
    _editSkybox() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                global.dataStore.updateSkybox(response.data.skybox);
    ...
    _deleteSkybox() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                global.dataStore.deleteSkybox(response.data.skybox);
...
global.librarySkybox = new LibrarySkybox();
