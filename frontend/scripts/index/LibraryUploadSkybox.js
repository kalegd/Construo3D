...
export default class LibraryUploadSkybox {
    constructor() {
    ...
    _setupEventListeners() {
        ...
        for(let i = 0; i < directions.length; i++) {
            ...
            $("#" + id).change(() => { this._previewImage(id); });
        }
        document.getElementById("library-upload-skybox-submit")
    ...
    _uploadFile() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                global.dataStore.addSkybox(response.data.skybox);
...
global.libraryUploadSkybox = new LibraryUploadSkybox();
