...
export default class LibraryModelVersion {
    constructor() {
    ...
    _setupEventListeners() {
        document.getElementById("library-save-model-version-submit")
            .addEventListener("click", () => { this._saveModelVersion(); });
        document.getElementById("library-delete-model-version-submit")
            .addEventListener("click", () => { this._deleteModelVersion(); });
    }
    ...
    _saveModelVersion() {
        ...
        let request = {
            ...
            'model_id': global.libraryModel.getId(),
            'fields': {}
        };
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                global.dataStore.updateModelVersion(
    ...
    _deleteModelVersion() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                global.dataStore.deleteModelVersion(
                    response.data.model_id,
                    response.data.model_version
                );
    ...
    setVersion(version) {
        ...
        let fields = global.libraryModel.getFields();
...
global.libraryModelVersion = new LibraryModelVersion();
