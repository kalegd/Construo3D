class LibraryScript {
    constructor() {
        ...
        this._editScript = this._editScript.bind(this);
        this._deleteScript = this._deleteScript.bind(this);
        this._setupEventListeners();
    }

    _setupEventListeners() {
        document.getElementById("library-edit-script-submit").addEventListener("click", this._editScript, false);
        document.getElementById("library-delete-script-submit").addEventListener("click", this._deleteScript, false);
    }
    ...
    _editScript() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                dataStore.renameScript(response.data.script);
    ...
    _deleteScript() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                dataStore.deleteScript(response.data.script);
